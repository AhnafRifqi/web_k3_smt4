...
<form method="GET" class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 mb-4 shadow-sm">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('employees.index') }}" class="px-3 py-2 text-sm text-gray-500 bg-gray-100 rounded-lg hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-400 transition-colors">Reset</a>
            @endif
        </div>
    </div>
</form>
